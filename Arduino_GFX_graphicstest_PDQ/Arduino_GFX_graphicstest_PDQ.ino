...
// Arduino_HX8352C *tft = new Arduino_HX8352C(bus, TFT_RST, TFT_ROTATION, true /* IPS */);

// HX8357B IPS LCD 320x480
// Arduino_HX8357B *tft = new Arduino_HX8357B(bus, TFT_RST, TFT_ROTATION, true /* IPS */);

// ILI9225 LCD 176x220
// Arduino_ILI9225 *tft = new Arduino_ILI9225(bus, TFT_RST, TFT_ROTATION);

// ILI9341 LCD 240x320
Arduino_ILI9341 *tft = new Arduino_ILI9341(bus, TFT_RST, TFT_ROTATION);

// ILI9486 LCD 320x480
// Arduino_ILI9486 *tft = new Arduino_ILI9486(bus, TFT_RST, TFT_ROTATION);

// SEPS525 OLED 160x128
// Arduino_SEPS525 *tft = new Arduino_SEPS525(bus, TFT_RST, TFT_ROTATION);

// SSD1331 OLED 96x64
// Arduino_SSD1331 *tft = new Arduino_SSD1331(bus, TFT_RST, TFT_ROTATION);

// SSD1351 OLED 128x128
// Arduino_SSD1351 *tft = new Arduino_SSD1351(bus, TFT_RST, TFT_ROTATION);

// ST7735 LCD
// 1.8" REDTAB 128x160
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION);
// 1.8" BLACKTAB 128x160
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION, false /* IPS */, 128 /* width */, 160 /* height */, 2 /* col offset 1 */, 1 /* row offset 1 */, 2 /* col offset 2 */, 1 /* row offset 2 */, false /* BGR */);
// 1.8" GREENTAB A 128x160
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION, false /* IPS */, 128 /* width */, 160 /* height */, 2 /* col offset 1 */, 1 /* row offset 1 */, 2 /* col offset 2 */, 1 /* row offset 2 */);
// 1.8" GREENTAB B 128x160
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION, false /* IPS */, 128 /* width */, 160 /* height */, 2 /* col offset 1 */, 3 /* row offset 1 */, 2 /* col offset 2 */, 1 /* row offset 2 */);
// 1.8" Wide angle LCD 128x160
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION, false /* IPS */, 128 /* width */, 160 /* height */, 0 /* col offset 1 */, 0 /* row offset 1 */, 0 /* col offset 2 */, 0 /* row offset 2 */, false /* BGR */);
// 1.5" GREENTAB B 128x128
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION, false /* IPS */, 128 /* width */, 128 /* height */, 2 /* col offset 1 */, 3 /* row offset 1 */, 2 /* col offset 2 */, 1 /* row offset 2 */);
// 1.5" GREENTAB C 128x128
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION, false /* IPS */, 128 /* width */, 128 /* height */, 0 /* col offset 1 */, 32 /* row offset 1 */);
// 0.96" IPS LCD 80x160
// Arduino_ST7735 *tft = new Arduino_ST7735(bus, TFT_RST, TFT_ROTATION, true /* IPS */, 80 /* width */, 160 /* height */, 26 /* col offset 1 */, 1 /* row offset 1 */, 26 /* col offset 2 */, 1 /* row offset 2 */);

// ST7789 LCD
// 2.4" LCD 240x320
// Arduino_ST7789 *tft = new Arduino_ST7789(bus, TFT_RST, TFT_ROTATION);
// 2.4" IPS LCD 240x320
// Arduino_ST7789 *tft = new Arduino_ST7789(bus, TFT_RST, TFT_ROTATION, true /* IPS */);
// 1.3"/1.5" square IPS LCD 240x240
// Arduino_ST7789 *tft = new Arduino_ST7789(bus, TFT_RST, TFT_ROTATION, true /* IPS */, 240 /* width */, 240 /* height */, 0 /* col offset 1 */, 80 /* row offset 1 */);
